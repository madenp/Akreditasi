// ========================================
// Sitasi Ika Maya Sari Content Component
// ========================================
const SitasiIkaContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/16_Ika_Maya_Sari.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Ika Maya Sari</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartIka" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartIka" />
                            </div>
                        </div>
                    </div>
                </div>
