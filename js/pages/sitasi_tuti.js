// ========================================
// Sitasi Tuti Content Component
// ========================================
const SitasiTutiContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/12_Tuti_Dharmawati.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Tuti Dharmawati</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartTuti" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartTuti" />
                            </div>
                        </div>
                    </div>
                </div>
