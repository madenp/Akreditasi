// ========================================
// Sitasi Santiadji Mustafa Content Component
// ========================================
const SitasiSantiadjiContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/18_Santiadji_Mustafa.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Santiadji Mustafa</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartSantiadji" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartSantiadji" />
                            </div>
                        </div>
                    </div>
                </div>
