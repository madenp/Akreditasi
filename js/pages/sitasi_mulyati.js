// ========================================
// Sitasi Mulyati Content Component
// ========================================
const SitasiMulyatiContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/07_Mulyati_Akib.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Mulyati Akib</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartMulyati" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartMulyati" />
                            </div>
                        </div>
                    </div>
                </div>
