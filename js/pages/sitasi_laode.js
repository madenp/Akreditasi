// ========================================
// Sitasi La Ode Content Component
// ========================================
const SitasiLaOdeContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/04_La_Ode_Anto.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - La Ode Anto</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartLaOde" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartLaOde" />
                            </div>
                        </div>
                    </div>
                </div>
