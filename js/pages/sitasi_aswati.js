// ========================================
// Sitasi Wa Ode Aswati Content Component
// ========================================
const SitasiAswatiContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/15_Wa_Ode_Aswati.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Wa Ode Aswati</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartAswati" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartAswati" />
                            </div>
                        </div>
                    </div>
                </div>
