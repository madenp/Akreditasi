// ========================================
// Sitasi Nasrullah Content Component
// ========================================
const SitasiNasrullahContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/05_Nasrullah_Dali.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Nasrullah Dali</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartNasrullah" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartNasrullah" />
                            </div>
                        </div>
                    </div>
                </div>
