// ========================================
// Sitasi Nitri Content Component
// ========================================
const SitasiNitriContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/11_Nitri_Mirosea.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Nitri Mirosea</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartNitri" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartNitri" />
                            </div>
                        </div>
                    </div>
                </div>
