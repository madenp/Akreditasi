// ========================================
// Sitasi Ishak Content Component
// ========================================
const SitasiIshakContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/03_Ishak_Awaluddin.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Ishak Awaluddin</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartIshakContent" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartIshakContent" />
                            </div>
                        </div>
                    </div>
                </div>
