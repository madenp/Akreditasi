// ========================================
// Sitasi Andi Muh Fuad Content Component
// ========================================
const SitasiAndiMuhFuadContent = () => {
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Andi Muh Fuad</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartAndiMuhFuad" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartAndiMuhFuad" />
                            </div>
                        </div>
                    </div>
                </div>
