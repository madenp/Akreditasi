// ========================================
// Sitasi Erwin Content Component
// ========================================
const SitasiErwinContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/10_Erwin_Hadisantoso.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Erwin Hadisantoso</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartErwin" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartErwin" />
                            </div>
                        </div>
                    </div>
                </div>
