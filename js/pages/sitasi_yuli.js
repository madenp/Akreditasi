// ========================================
// Sitasi Yuli Lestari Content Component
// ========================================
const SitasiYuliContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/19_Yuli_Lestari.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Yuli Lestari</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartYuli" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartYuli" />
                            </div>
                        </div>
                    </div>
                </div>
