// ========================================
// Sitasi Hasbudin Content Component
// ========================================
const SitasiHasbudinContent = () => {
    ...
    const getChartData = () => {
        // ... (Chart logic remains same, can be refactored to use processed data for consistency but existing logic is fine)
        const yearMap = {};
        data.forEach(item => {
            if (!yearMap[item.year]) yearMap[item.year] = 0;
            yearMap[item.year] += item.citations;
    ...
    // Sticky Header Style Helper (Simplified from tabel23a)
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Hasbudin</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartHasbudin" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartHasbudin" />
                            </div>
                        </div>
                    </div>
                </div>
