// ========================================
// Sitasi Muntu Content Component
// ========================================
const SitasiMuntuContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/08_Muntu_Abdullah.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Muntu Abdullah</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartMuntu" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartMuntu" />
                            </div>
                        </div>
                    </div>
                </div>
