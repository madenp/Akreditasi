// ========================================
// Sitasi Emillia Content Component
// ========================================
const SitasiEmilliaContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/09_Emillia_Nurdin.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Emillia Nurdin</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartEmillia" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartEmillia" />
                            </div>
                        </div>
                    </div>
                </div>
