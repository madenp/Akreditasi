// ========================================
// Sitasi Safaruddin Content Component
// ========================================
const SitasiSafaruddinContent = () => {
    ...
    useEffect(() => {
        fetch('Sitasi/17_Safaruddin.json')
    ...
    return (
        <div className="content fade-in">
            <div className="breadcrumb-wrapper">
                <h1 className="page-title">Sitasi - Safaruddin</h1>
            ...
            <div className="row">
                    ...
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="line" data={lineChartData} options={chartOptions} id="lineChartSafaruddin" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col col-4">
                    <div className="box">
                        ...
                        <div className="box-body">
                            <div className="chart-container">
                                <ChartComponent type="bar" data={barChartData} options={barOptions} id="barChartSafaruddin" />
                            </div>
                        </div>
                    </div>
                </div>
